"""Bitwise-lossless activation compression and measured adaptive selection."""
...
class AdaptiveCompressionController:
    """Select compression from measured costs, never from profile names."""
    ...
    def decide(
        ...
        *,
        ...
        bytes_per_second = bandwidth_bps / 8.0 if bandwidth_bps else float("inf")
