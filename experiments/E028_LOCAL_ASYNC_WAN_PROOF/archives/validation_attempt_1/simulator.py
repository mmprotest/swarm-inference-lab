...
class Measurements:
    ...
    def stage(self, chunk, stage, *, held_out=False, condition=None):
...
class Replay:
    ...
    def stage_ready(self,index):
        ...
        row, provenance = self.m.stage(chunk,index,held_out=self.held_out,condition=(self.run["k"],self.run["w"]))
