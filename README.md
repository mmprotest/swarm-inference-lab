...
powershell -ExecutionPolicy Bypass -File .\scripts\install.ps1 `
  -SourceWheel .\dist\swarm_inference_lab-0.1.0rc4-py3-none-any.whl -Json
```

```bash
sh ./scripts/install.sh --source-wheel ./dist/swarm_inference_lab-0.1.0rc4-py3-none-any.whl --json
```
